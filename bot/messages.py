...
HELP_TEXT = (
    ...
    "4. Group admins can turn downloading off/on with /disablebot and /enablebot\n\n"
    "<b>Private Instagram accounts</b>\n"
    "<code>/request username_or_id</code> — sends a follow request and lets "
    "you know here once it's accepted or declined\n\n"
    "<b>Supported</b>\n"
